"""
Nhom : 
N19DCCN101 - Trần Quang	Long
N19DCCN224 - Ngô Văn Việt
N19DCCN057 - Lê Công Hiếu
"""
...
def taciAstar(state,target):# Add inputs if more are required
    states = [src]
    g = 0
    visited_states =[]
    while len(states):
...
# Testing 
# -1 là vị trí x (trống) trong dữ liệu mẫu
filename = "taci.txt"
src = []
target = []
start_flag = False
...
if __name__ == "__main__":
    ...
    print("Start source:", src)
    print("Goal source:", target)

    taciAstar(src, target)
